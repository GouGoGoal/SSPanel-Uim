...
//基本设置--------------------------------------------------------------------------------------------
$System_Config['key'] = '1234354654756756123123';						//!!! 瞎 jb 修改此key为随机字符串确保网站安全 !!!
...
//网易域名邮箱
$System_Config['smtp_host'] = 'smtp.zoho.com';
...
#$System_Config['smtp_username'] = 'souloutclub@gmail.com';
#$System_Config['smtp_port'] = '587';
#$System_Config['smtp_name'] = '靈魂出竅';
##$System_Config['smtp_sender'] = 'souloutclub@gmail.com';
#$System_Config['smtp_sender'] = 'souloutclub@gmail.com';
#$System_Config['smtp_passsword'] = 'gouzekun';
#$System_Config['smtp_ssl'] = 'true';
...
$System_Config['defaultTraffic'] = '2';						//用户初始流量 单位GB
$System_Config['user_expire_in_default']='1';			//用户账户过期时间，在注册时设置。（天）
...
$System_Config['reg_method']='none';						//注册时默认加密方式
$System_Config['reg_protocol']='auth_chain_a';					//注册时默认协议
$System_Config['reg_protocol_param']='';					//注册时默认协议参数
$System_Config['reg_obfs']='plain';							//注册时默认混淆方式
$System_Config['reg_obfs_param']='';						//注册时默认混淆参数
$System_Config['reg_forbidden_ip']='';	//注册时默认禁止访问IP列表，半角英文逗号分割
$System_Config['min_port']='30000';							//用户端口池最小值
$System_Config['max_port']='39999';							//用户端口池最大值
$System_Config['reg_forbidden_port']='';					//注册时默认禁止访问端口列表，半角英文逗号分割，支持端口段
$System_Config['mu_suffix']='download.windowsupdate.com';				//单端口多用户混淆参数后缀，可以随意修改，但请保持前后端一致
$System_Config['mu_regex']='%suffix';
//$System_Config['mu_regex']='%2m.%suffix';				//单端口多用户混淆参数表达式，%5m代表取用户特征 md5 的前五位，%id 代表用户id,%suffix 代表上面这个后缀。

#邀请链接
$System_Config['inviteNum'] = '20';			//注册后的邀请链接可用次数
$System_Config['invite_get_money']='0';		//新用户通过私人邀请链接注册时，获得奖励金额（作为初始资金）
$System_Config['invite_price']='0.5';		//用户购买邀请码所需要的价格，价格小于0时视为不开放购买
$System_Config['custom_invite_price']='0.5';		//用户定制邀请码所需要的价格，价格小于0时视为不开放购买

#邮箱验证
$System_Config['enable_email_verify']='true';		//是否启用注册邮箱验证码
$System_Config['email_verify_ttl']='600';			//邮箱验证码有效期
$System_Config['email_verify_iplimit']='10';		//验证码有效期内，单IP可请求验证码次数


//已注册用户设置---------------------------------------------------------------------------------------
#基础
$System_Config['checkinMin'] = '50';			//用户签到最少流量 单位MB
$System_Config['checkinMax'] = '150';			//用户签到最多流量
$System_Config['auto_clean_uncheck_days']='-1';	        //自动清理多少天没签到的0级用户，小于等于0时关闭
$System_Config['auto_clean_unused_days']='10';	        //自动清理多少天没使用且无流量的用户，小于等于0时关闭
$System_Config['auto_clean_min_money']='0';		//余额低于多少的0级用户可以被清理
...
$System_Config['enable_bought_extend']='false';	        //购买时是否延长等级期限（同等级配套）
...
$System_Config['notify_limit_value'] = '512';			//当上一项为per时，此处填写百分比；当上一项为mb时，此处填写流量
$System_Config['mergeSub'] = 'false';						//合并订阅设置 可选项 false / true

//Bot 设置--------------------------------------------------------------------------------------------
#通用
$System_Config['qrcode']='online';				//二维码解码方式，online，phpzbar，zxing_online，zxing_local
...
$System_Config['telegram_token']='864635192:AAFPfI9CLrRNDvHxHwfJc22ur3VscS9wSNA';				//Telegram bot,bot 的 token ，跟 father bot 申请
$System_Config['telegram_chatid']='-1001493289099';				//Telegram bot,群组会话 ID,把机器人拉进群里之后跟他 /ping 一下即可得到。
...
$System_Config['telegram_bot']='soulout_bot';				//Telegram 机器人账号
$System_Config['telegram_group_quiet']='true';		//Telegram 机器人在群组中不回应
$System_Config['telegram_request_token']='souloutclub';		//Telegram 机器人请求Key，随意设置，由大小写英文和数字组成，更新这个参数之后请 php xcat setTelegram
...
#工单系统设置
$System_Config['enable_ticket']='false';		//是否开启工单系统
$System_Config['mail_ticket']='false';		//是否开启工单邮件提醒
...
$System_Config['payment_system']='wolfpay';
//$System_Config['payment_system']='none';
#BitPay支付
$System_Config['bitpay_secret']='2bb563b0-90bc-11e9-9ea3-a9df6373fb3b';
#野狼支付
$System_Config['wolfpay']=['config'=>['hid'=>'111125','key'=>'51fa640cf366b95d0c7bbe4672f82da6','url'=>'51fa6.wolfpay.vip']];
#曜空支付
$System_Config['flyfoxpay']=['config'=>['hid'=>'1023','key'=>'9H3Hu9rPRzRR96ojRIQ9rrlpBZ0Xfh3Z','mail'=>'souloutclub@gmail.com']];	
...
//其他面板显示设置------------------------------------------------------------------------------------------
#后台商品列表 销量统计
$System_Config['sales_period']='expire';	//统计指定周期内的销量，值为【expire/任意大于0的整数】
...
$System_Config['enable_detect_offline_useScFtqq']='false';
...
$System_Config['jump_delay']='600';				//跳转延时，单位ms，不建议太长

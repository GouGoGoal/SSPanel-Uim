...
$System_Config['mu_regex']='%4m.%suffix';				//单端口多用户混淆参数表达式，%5m代表取用户特征 md5 的前五位，%id 代表用户id,%suffix 代表上面这个后缀。
...
//已注册用户设置---------------------------------------------------------------------------------------
#基础
$System_Config['checkinMin'] = '30';			//用户签到最少流量 单位MB
$System_Config['checkinMax'] = '60';			//用户签到最多流量
$System_Config['auto_clean_uncheck_days']='-1';	        //自动清理多少天没签到的0级用户，小于等于0时关闭
$System_Config['auto_clean_unused_days']='7';	        //自动清理多少天没使用的0级用户，小于等于0时关闭

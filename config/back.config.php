...
$System_Config['user_expire_in_default']='7';			//用户账户过期时间，在注册时设置。（天）
...
$System_Config['reg_protocol']='auth_chain_b';					//注册时默认协议
...
$System_Config['auto_clean_unused_days']='30';	        //自动清理多少天没使用且无流量的用户，小于等于0时关闭
